...
const MENU_ITEMS = [
    ...
    { name: "Tools & Features", icon: Wrench, href: "/admin/tools" },
    { name: "SaaS & Billing", icon: CreditCard, href: "/admin/settings/saas" },
    { name: "API Management", icon: ShieldCheck, href: "/admin/settings/apis" },
    { name: "Ads Management", icon: Megaphone, href: "/admin/settings/ads" },
    { name: "General Settings", icon: Settings, href: "/admin/settings/general" },
    { name: "Email Config", icon: Mail, href: "/admin/settings/email" },
    { name: "Language & RTL", icon: Globe, href: "/admin/settings/language" },
